...
module "permission_group" {
  source     = "github.com/linolabx/tfmodules?ref=cf-account-permission@v0.0.1"
  ...
  policies = [
    {
      effect = "allow"
      permission_groups = [
        { id = module.permission_group.zone["Zone Read"] , meta = {}},
      ],
      resources = {
    ...
    },
    {
      effect = "allow"
      permission_groups = [
        { id = module.permission_group.zone["DNS Write"], meta = {} }
      ]
      resources = {
